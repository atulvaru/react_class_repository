...
export const MiniToggle = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`w-[2.5rem] h-[2.5rem] bg-white rounded-full flex items-center border-2 border-gray-400 justify-center text-xl transform transition-transform duration-300 ${
